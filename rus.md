...
В начале этого года я находился на начальном этапе редизайна [сайта 
нашей компании][1]. Мы уже решили, что будем использовать 
...
к усовершенствованию процесса работы над отзывчивыми сайтами. В этой 
...
страницы, преобразовывая его из версии для маленьких экранов в версию для больших 
устройств. 
...
Для упрощения работы **мы создали изображение**, которое установили фоном
...
фронтэнд разработчиков, с начала работы с отзывчивым дизайном мы придерживались 
